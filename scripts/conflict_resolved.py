...
if __name__ == '__main__':
  ...
  screenshot.save('chromium-nix-screenshots/tsrc-33.png')
  ...
  time.sleep(3)
  screenshot = create_screenshot_with_grid(50)
  screenshot.save('chromium-nix-screenshots/tsrc-34.png')

  # Make popup modal go away.
  pyautogui.hotkey('ctrl', 'r')
  time.sleep(5)
  screenshot = create_screenshot_with_grid(50)
  screenshot.save('chromium-nix-screenshots/tsrc-35.png')
